...
cur=conn.cursor()
cur.execute("DROP DATABASE IF EXISTS spatial_db1")
print('creating spatial_db1')
cur.execute("CREATE DATABASE spatial_db1")
cur.close()
conn.close()

conn=pymysql.connect(host='localhost', port=3306, user='root',passwd='fdLfums!',db='spatial_db1')
cur=conn.cursor()
